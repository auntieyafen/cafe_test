...
const CountPage = () => {
  ...
  return (
    <div>
      <p className={`justify-center mb-3 text-2xl font-semibold`}>{targetNumber}</p>
      <button className={`justify-center mb-3 text-2xl font-semibold`} onClick={handleClick}>+5</button>
    </div>
  );
};
